...
MRO is now updated to version 4.0.2 with RevoUtilsMath::getMKLthreads() and setMKLthreads() again working properly.  I have updated the information in this document:  
